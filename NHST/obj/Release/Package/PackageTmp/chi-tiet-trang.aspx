<%@ Page Title="" Language="C#" MasterPageFile="~/Muahang86alpha.Master" AutoEventWireup="true" CodeBehind="chi-tiet-trang.aspx.cs" Inherits="NHST.chi_tiet_trang2" %>
    ...
    <main class="main">
        ...
        <asp:Panel runat="server" ID="pnFull">
            <section class="about-section sec" style="padding:unset !important">
                <div class="container" style="width: 1024px; margin: 60px auto;">
