                                ...
                                if (userwallet >= custDeposit)
                                {
                                    ...
                                    if (st == 1)
                                    {
                                        ...
                                        if (setNoti != null)
                                        {
                                            ...
                                            //                    "Thông báo tại Yến Phát China.", "Đơn hàng " + o.ID + " đã được đặt cọc.", "");
                                            //            }
                                            //            catch { }
                                            //        }
                                            //    }
                                        ...
                                        if (setNoti.IsSentEmailAdmin == true)
                                        {
                                            ...
                                            if (admins.Count > 0)
                                            {
                                                foreach (var admin in admins)
                                                {
                                                    ...
                                                    {
                                                        PJUtils.SendMailGmail("monamedia", "uvnajxzzurygsduf", admin.Email,
                                                            "Thông báo tại Yến Phát China.", "Đơn hàng " + item.MainOrderID + " đã yêu cầu giao hàng.", "");
                                                    }
                                                    catch { }
                                                }
                                            }
                                                    ...
                                                    if (setNoti.IsSentEmailAdmin == true)
                                                    {
                                                        ...
                                                        if (admins.Count > 0)
                                                        {
                                                            foreach (var admin in admins)
                                                            {
                                                                ...
                                                                {
                                                                    PJUtils.SendMailGmail("monamedia", "uvnajxzzurygsduf", admin.Email,
                                                                        "Thông báo tại Yến Phát China.", "Đơn hàng " + o.ID + " đã được thanh toán.", "");
                                                                }
                                                                catch { }
                                                            }
                                                        }
